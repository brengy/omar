...
let gameOver = false;
let player = { x: 50, y: canvas.height - 100, width: 80, height: 120, speed: 5, bullets: [], isShooting: false };
let enemy = { x: canvas.width - 100, y: 50, width: 80, height: 100, speed: 3, bullets: [], direction: 1, hitCount: 0 };

// Load images
const backgroundImage = new Image();
backgroundImage.src = 'bbbb2.jpg';  // Use the path of the background image used in level 3
